...
* Allows adding additional configuration files to WEB-INF through /config folder
...
This repo is setup to trigger an automated build of the image [grantemsley/jaserpserver](https://hub.docker.com/r/grantemsley/jasperserver/) on Docker Hub.
